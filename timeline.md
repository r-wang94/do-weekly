# Do Weekly - Planned Themes

> Source of truth: `episodes/` directory. Recorded = has `recording.mp3`. Planned = has `concept.md`/`script.md` but no recording. Conceptual = timeline only, no episode folder yet.
...
**Life coaching**
- **Connection** - Loneliness is a signal, not a shame
- **Presence** - Where are you when you're not here?
- **Values** - Are you living by someone else's rules?
- **Meaning** - What are you doing this for?
- **Resistance** - What you resist, persists
- **Boundaries** - The kindness of no
- **Seasons** - Everything is a phase
- **Attention** - Where attention goes, energy flows
- **Horizon** - It moves when you do
- **Outside** - Stop reaching out for what only works in
**Health-specific**
- **Supermarket** - Environment beats willpower
- **9pm** - Why eating late hits different
- **Campfire** - The 90-minute wind-down
- **Pension** - Your muscles are your longevity pension
- **Debt** - Sleep debt doesn't negotiate
- **Celebrate** - Emotions create habits, not repetition
